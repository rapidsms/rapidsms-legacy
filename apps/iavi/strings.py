...
strings = {
    ...
    "pin_mismatch":             "Error %(alias)s. PINs did not match.",
    ...
    "id_format":                "Error. Id must be 3 numeric digits. You sent %(alias)s",
    "time_format":              "Error %(alias)s. Time must be 4 numeric digits between 0000 and 2359. You sent %(time)s",
